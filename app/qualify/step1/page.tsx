...
export default function QualifyStep1() {
  ...
  const allQuestionsAnswered =
    answers.recentAccident !== null && answers.notAtFault !== null && answers.ownVehicle !== null
      ...
      <main className="flex-1 container max-w-3xl mx-auto px-4 py-16 animate-fade-in">
        ...
        <Card className="w-full border-0 shadow-card rounded-2xl overflow-hidden animate-slide-up">
          <CardHeader className="text-center pb-4 pt-8 px-8">
            ...
            <CardTitle className="text-3xl font-bold">Step 1: Qualify</CardTitle>
            <CardDescription className="text-base mt-2">Answer these questions to see if you qualify</CardDescription>
          </CardHeader>
          <CardContent className="space-y-8 px-8">
            <div className="space-y-5 bg-gray-50 p-6 rounded-xl">
              <h3 className="text-lg font-medium text-center">Were you in a car accident in the last 4 years?</h3>
              <div className="flex justify-center gap-4">
                <Button
                  variant={answers.recentAccident === true ? "default" : "outline"}
                  className={
                    answers.recentAccident === true ? "bg-success-600 hover:bg-success-700 shadow-md" : "shadow-sm"
                  }
                ...
                <Button
                  variant={answers.recentAccident === false ? "default" : "outline"}
                  className={answers.recentAccident === false ? "bg-red-600 hover:bg-red-700 shadow-md" : "shadow-sm"}
            ...
            <div className="space-y-5 bg-gray-50 p-6 rounded-xl">
              <h3 className="text-lg font-medium text-center">Was it the other person's fault?</h3>
              <div className="flex justify-center gap-4">
                <Button
                  variant={answers.notAtFault === true ? "default" : "outline"}
                  className={
                    answers.notAtFault === true ? "bg-success-600 hover:bg-success-700 shadow-md" : "shadow-sm"
                  }
                ...
                <Button
                  ...
                  className={answers.notAtFault === false ? "bg-red-600 hover:bg-red-700 shadow-md" : "shadow-sm"}
            ...
            <div className="space-y-5 bg-gray-50 p-6 rounded-xl">
              <h3 className="text-lg font-medium text-center">Do you own the damaged vehicle (not lease)?</h3>
              <div className="flex justify-center gap-4">
                <Button
                  variant={answers.ownVehicle === true ? "default" : "outline"}
                  className={
                    answers.ownVehicle === true ? "bg-success-600 hover:bg-success-700 shadow-md" : "shadow-sm"
                  }
                ...
                <Button
                  ...
                  className={answers.ownVehicle === false ? "bg-red-600 hover:bg-red-700 shadow-md" : "shadow-sm"}
          ...
          <CardFooter className="px-8 pb-8">
            <Button className="w-full py-6 text-lg" onClick={handleContinue} disabled={!allQuestionsAnswered}>
              Continue
            </Button>
          </CardFooter>
        </Card>
